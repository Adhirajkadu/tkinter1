...
class RestaurantOrderManagement:
    ...
    def setup_background(self, root):
        ...
        canvas.pack()
        original_image = tk.PhotoImage(file="C:/Users/Neela/OneDrive/Desktop/Python/tkinter/background.png")
        background_image = original_image.subsample(original_image.width() // bg_height,original_image.width() // bg_height)
